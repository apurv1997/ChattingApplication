...
public class Server extends JFrame implements ActionListener {        //class JFrame in swing package
    ...
    Server() {    //constructor
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/person2.jpg"));
...
//        a1.setBackground(Color.PINK);
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            s = skt.accept();
            din = new DataInputStream(s.getInputStream());      //Vo data jo aayega.
            dout = new DataOutputStream(s.getOutputStream());   // Vo data jo jayegaa (apn bhejenge).

            msgInput = din.readUTF();
            a1.setText(a1.getText()+"'n"+msgInput);
